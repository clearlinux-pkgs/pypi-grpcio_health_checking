...
Source0  : https://files.pythonhosted.org/packages/8b/0e/62743c098e80dde057afc50f9d681a5ef06cfbd4be377801d0d7e2a0737d/grpcio_health_checking-1.71.0.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.71.0
cd %{_builddir}/grpcio_health_checking-1.71.0
pushd ..
cp -a grpcio_health_checking-1.71.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741775957
