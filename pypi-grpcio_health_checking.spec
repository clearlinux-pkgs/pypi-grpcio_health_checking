...
Version  : 1.48.0
Release  : 26
URL      : https://files.pythonhosted.org/packages/63/c0/01586bc54e77da159266cf21da02274fbfcaefa57d50f53879549711d3cd/grpcio-health-checking-1.48.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/63/c0/01586bc54e77da159266cf21da02274fbfcaefa57d50f53879549711d3cd/grpcio-health-checking-1.48.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.48.0
cd %{_builddir}/grpcio-health-checking-1.48.0
pushd ..
cp -a grpcio-health-checking-1.48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659367796
