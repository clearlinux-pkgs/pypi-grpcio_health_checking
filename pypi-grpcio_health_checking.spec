...
Version  : 1.51.0
Release  : 35
URL      : https://files.pythonhosted.org/packages/f6/8e/a2caddd491068756f84fc10de8f94c5a2a246db8d77899bc19428296a4d6/grpcio-health-checking-1.51.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f6/8e/a2caddd491068756f84fc10de8f94c5a2a246db8d77899bc19428296a4d6/grpcio-health-checking-1.51.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.51.0
cd %{_builddir}/grpcio-health-checking-1.51.0
pushd ..
cp -a grpcio-health-checking-1.51.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669131963
