...
Version  : 1.65.2
Release  : 63
URL      : https://files.pythonhosted.org/packages/bb/a6/b153feae136565f68f472ec9a452892d341a13a2fe61ab72f46de05dab8a/grpcio_health_checking-1.65.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/bb/a6/b153feae136565f68f472ec9a452892d341a13a2fe61ab72f46de05dab8a/grpcio_health_checking-1.65.2.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.65.2
cd %{_builddir}/grpcio_health_checking-1.65.2
pushd ..
cp -a grpcio_health_checking-1.65.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722441492
