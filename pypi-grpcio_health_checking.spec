...
Version  : 1.46.3
Release  : 23
URL      : https://files.pythonhosted.org/packages/ef/ae/9f76cb0062cb451ecf499656845840851638c5a9db98313a8d1967edff40/grpcio-health-checking-1.46.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/ef/ae/9f76cb0062cb451ecf499656845840851638c5a9db98313a8d1967edff40/grpcio-health-checking-1.46.3.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.46.3
cd %{_builddir}/grpcio-health-checking-1.46.3
pushd ..
cp -a grpcio-health-checking-1.46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653335145
...
cp %{_builddir}/grpcio-health-checking-1.46.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_health_checking/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
