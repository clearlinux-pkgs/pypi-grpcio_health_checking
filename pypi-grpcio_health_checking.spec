...
Version  : 1.62.0
Release  : 55
URL      : https://files.pythonhosted.org/packages/ad/fd/5b772b8982638b244d9d3bd2a7cf833cb24b56bab9900a392625e9bc6728/grpcio-health-checking-1.62.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ad/fd/5b772b8982638b244d9d3bd2a7cf833cb24b56bab9900a392625e9bc6728/grpcio-health-checking-1.62.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.62.0
cd %{_builddir}/grpcio-health-checking-1.62.0
pushd ..
cp -a grpcio-health-checking-1.62.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708615502
