...
Version  : 1.62.1
Release  : 56
URL      : https://files.pythonhosted.org/packages/42/cf/8f437cdbf5895a0938f80d59a2a9b1eab5442b50485926ed58149fac3ed4/grpcio-health-checking-1.62.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/cf/8f437cdbf5895a0938f80d59a2a9b1eab5442b50485926ed58149fac3ed4/grpcio-health-checking-1.62.1.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.62.1
cd %{_builddir}/grpcio-health-checking-1.62.1
pushd ..
cp -a grpcio-health-checking-1.62.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710170890
