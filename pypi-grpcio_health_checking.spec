...
Version  : 1.47.0
Release  : 24
URL      : https://files.pythonhosted.org/packages/e3/12/45da33f490b2a5795f12f8462037a5142d73ef2d8db7c94ad2a8794615af/grpcio-health-checking-1.47.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e3/12/45da33f490b2a5795f12f8462037a5142d73ef2d8db7c94ad2a8794615af/grpcio-health-checking-1.47.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.47.0
cd %{_builddir}/grpcio-health-checking-1.47.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655932562
...
cp %{_builddir}/grpcio-health-checking-1.47.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_health_checking/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
