...
Version  : 1.65.1
Release  : 62
URL      : https://files.pythonhosted.org/packages/66/16/0f2c51df82f24033028ca5c8d5546738b974537ddae949de91544b504ce8/grpcio_health_checking-1.65.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/66/16/0f2c51df82f24033028ca5c8d5546738b974537ddae949de91544b504ce8/grpcio_health_checking-1.65.1.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.65.1
cd %{_builddir}/grpcio_health_checking-1.65.1
pushd ..
cp -a grpcio_health_checking-1.65.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721317018
