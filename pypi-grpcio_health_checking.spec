...
Source0  : https://files.pythonhosted.org/packages/07/37/33de60a6ee4c6cf67abbe781bc8c69e7f04610997874383eded02d4ab133/grpcio_health_checking-1.70.0.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.70.0
cd %{_builddir}/grpcio_health_checking-1.70.0
pushd ..
cp -a grpcio_health_checking-1.70.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737732320
