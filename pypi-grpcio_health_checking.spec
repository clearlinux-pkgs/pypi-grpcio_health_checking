...
Version  : 1.65.0
Release  : 61
URL      : https://files.pythonhosted.org/packages/c5/86/cd63b0354c80dafa6c4cf442d11e9f6f87bc45d5692c6ca9d140d994d792/grpcio_health_checking-1.65.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/c5/86/cd63b0354c80dafa6c4cf442d11e9f6f87bc45d5692c6ca9d140d994d792/grpcio_health_checking-1.65.0.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.65.0
cd %{_builddir}/grpcio_health_checking-1.65.0
pushd ..
cp -a grpcio_health_checking-1.65.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720715530
