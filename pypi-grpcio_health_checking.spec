...
Version  : 1.72.0
Release  : 78
URL      : https://files.pythonhosted.org/packages/67/5d/370d703ecee03c74417f18d8671e160c7d28a52bbfc02aab4087850eb3df/grpcio_health_checking-1.72.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/67/5d/370d703ecee03c74417f18d8671e160c7d28a52bbfc02aab4087850eb3df/grpcio_health_checking-1.72.0.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.72.0
cd %{_builddir}/grpcio_health_checking-1.72.0
pushd ..
cp -a grpcio_health_checking-1.72.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745590230
