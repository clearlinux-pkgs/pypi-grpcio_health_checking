...
Version  : 1.45.0
Release  : 18
URL      : https://files.pythonhosted.org/packages/9d/88/bddc45c48927df28be9f8c547d61913b42d1892790ba3ca99260356acc05/grpcio-health-checking-1.45.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/9d/88/bddc45c48927df28be9f8c547d61913b42d1892790ba3ca99260356acc05/grpcio-health-checking-1.45.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.45.0
cd %{_builddir}/grpcio-health-checking-1.45.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648148284
...
cp %{_builddir}/grpcio-health-checking-1.45.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_health_checking/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
