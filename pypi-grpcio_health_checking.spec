...
Source0  : https://files.pythonhosted.org/packages/ef/b8/d6d485e27d60174ba22c25587c1a97512c6a800633cfd6a8cd7943ad66e0/grpcio_health_checking-1.69.0.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.69.0
cd %{_builddir}/grpcio_health_checking-1.69.0
pushd ..
cp -a grpcio_health_checking-1.69.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736178920
