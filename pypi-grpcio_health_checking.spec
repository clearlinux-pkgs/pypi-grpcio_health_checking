...
Version  : 1.53.0
Release  : 40
URL      : https://files.pythonhosted.org/packages/32/5a/066583133d54df02ff361ac96bfec66b7c0ed8f5477ee9c01c5650839f43/grpcio-health-checking-1.53.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/5a/066583133d54df02ff361ac96bfec66b7c0ed8f5477ee9c01c5650839f43/grpcio-health-checking-1.53.0.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.53.0
cd %{_builddir}/grpcio-health-checking-1.53.0
pushd ..
cp -a grpcio-health-checking-1.53.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679954639
