...
%prep
%setup -q -n grpcio-health-checking-1.60.0
cd %{_builddir}/grpcio-health-checking-1.60.0
pushd ..
cp -a grpcio-health-checking-1.60.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702924876
