...
Version  : 1.64.1
Release  : 60
URL      : https://files.pythonhosted.org/packages/8a/29/d4f186bcd954c71d10c0e2257df6d50641a11e83603be05ea40cf6f817dd/grpcio_health_checking-1.64.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/29/d4f186bcd954c71d10c0e2257df6d50641a11e83603be05ea40cf6f817dd/grpcio_health_checking-1.64.1.tar.gz
...
%prep
%setup -q -n grpcio_health_checking-1.64.1
cd %{_builddir}/grpcio_health_checking-1.64.1
pushd ..
cp -a grpcio_health_checking-1.64.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717510951
